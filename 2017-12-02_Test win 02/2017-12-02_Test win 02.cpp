// 2017-12-02_Test win 02.cpp : definisce il punto di ingresso dell'applicazione.
//

#include "stdafx.h"
#include "2017-12-02_Test win 02.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MY20171202_TESTWIN02, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY20171202_TESTWIN02));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY20171202_TESTWIN02));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MY20171202_TESTWIN02);
